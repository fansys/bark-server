...
docker buildx build --platform linux/arm,linux/arm64,linux/386,linux/amd64 -t fansys/bark-server:${BUILD_VERSION} -f deploy/Dockerfile --push .
docker buildx build --platform linux/arm,linux/arm64,linux/386,linux/amd64 -t fansys/bark-server -f deploy/Dockerfile --push .
